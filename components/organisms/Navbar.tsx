...
export const Navbar = () => {
  ...
  const navItems: NavItemConfig[] = React.useMemo(() => [
    { 
      ...
      id: 'about', 
      icon: User,
      activeColorClass: 'bg-accent text-white shadow-lg scale-110',
      hoverColorClass: 'bg-white/50 backdrop-blur-sm text-slate-500 hover:bg-accent hover:text-white'
    },
    { 
      label: 'Expertise', 
      href: '#services', 
      id: 'services', 
      icon: Zap,
      activeColorClass: 'bg-primary text-white shadow-lg scale-110',
      hoverColorClass: 'bg-white/50 backdrop-blur-sm text-slate-500 hover:bg-primary hover:text-white'
    },
    { 
      label: 'Work', 
      href: '#portfolio', 
    ...
    { 
      ...
      id: 'location', 
      icon: MapPin,
      activeColorClass: 'bg-primary text-white hover:bg-primary-dark shadow-xl',
      hoverColorClass: 'bg-white/50 backdrop-blur-sm text-slate-500 hover:bg-primary hover:text-white'
    },
  ], []);
